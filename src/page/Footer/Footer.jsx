...
const Footer = () => {
  ...
  return (
    <footer className="ff-fade-up  bg-white/5 backdrop-blur-md border-t border-white/10 mt-16">
      <div className="max-w-7xl fade-up mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Main Footer Grid */}
